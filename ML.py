...
# Вывод предсказанного эмбеддинга описания из сообщения пользователя
print("Предсказанный эмбеддинг описания из сообщения пользователя:", predicted_description_embedding)
...
print("Top 5 наиболее подходящих фильмов:")
